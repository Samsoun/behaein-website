...
export const SmartphoneMockup: React.FC = () => {
  return (
    <motion.div
      ...
      className="relative w-[280px] h-[550px] rounded-[42px] bg-zinc-900 border-[8px] border-zinc-800 shadow-[0_20px_50px_rgba(230,193,122,0.15)] flex flex-col overflow-hidden [transformStyle:preserve-3d] select-none"
      style={{
      ...
      <div className="absolute inset-0 bg-[#0A0D14] overflow-hidden rounded-[34px]">
        ...
        >
          <img 
            ...
            className="w-full h-full object-cover object-top animate-fade-in hover:scale-[1.03] transition-transform duration-500"
            draggable={false}
          />
        </a>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="h-10 border-b border-zinc-800/80 bg-zinc-950/80 flex items-center justify-between px-4 z-20">
        ...
        {/* Address Bar */}
        <div className="flex items-center gap-2 px-3 py-1 rounded bg-zinc-900 border border-zinc-800 w-[240px] md:w-[280px] h-6 justify-center">
          <Lock className="w-3 h-3 text-[#E6C17A]" />
          <span className="text-[10px] text-zinc-300 font-mono tracking-tight font-sans">https://sheen.berlin</span>
          <RefreshCw className="w-2.5 h-2.5 text-zinc-500 animate-spin-slow ml-2" />
        </div>
        ...
        <div className="flex gap-2">
          <button 
            ...
            className={`px-2 py-0.5 rounded text-[8px] font-bold tracking-wide uppercase transition-all ${
              seoTab === "preview" ? "bg-amber-100/10 text-amber-100 border border-amber-100/20" : "text-zinc-500"
            }`}
          >
          ...
          <button 
            ...
            className={`px-2 py-0.5 rounded text-[8px] font-bold tracking-wide uppercase transition-all ${
              seoTab === "metrics" ? "bg-amber-100/10 text-amber-100 border border-amber-100/20" : "text-zinc-500"
            }`}
          >
      ...
      <div className="flex-1 bg-[#09090b] relative overflow-hidden">
        {seoTab === "preview" ? (
          ...
          <div 
            dir={isRtl ? "rtl" : "ltr"}
            className="absolute inset-0 flex flex-col justify-between p-6 font-mono text-[9px] text-zinc-400 text-start"
          >
            <div className="flex justify-between items-center border-b border-zinc-800 pb-3">
              <span className="font-bold text-[#E6C17A] uppercase flex items-center gap-1">
            ...
            <div className="grid grid-cols-2 gap-4 flex-1 py-4">
              <div className="flex flex-col gap-2 bg-zinc-950/50 p-2.5 rounded-lg border border-zinc-800">
                <div className="text-[8px] font-bold uppercase tracking-wider text-zinc-500">{isRtl ? "کدهای نشانه گذاری شده" : "Structured Schema"}</div>
                <div className="text-[7.5px] leading-relaxed text-amber-100/90 font-mono whitespace-pre line-clamp-6">
{`{
  ...
  "aggregateRating": {
    ...
    "ratingValue": "4.9"
              ...
              <div className="flex flex-col justify-between bg-zinc-950/50 p-2.5 rounded-lg border border-zinc-800">
                <div className="text-[8px] font-bold uppercase tracking-wider text-zinc-500">{t("mockupBrowserAuditTag")}</div>
                ...
                <div className="text-[7.5px] text-zinc-500 border-t border-zinc-800 pt-1 mt-1 font-sans">
