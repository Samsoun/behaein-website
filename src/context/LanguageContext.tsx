...
const translations: Record<Locale, Translations> = {
  ...
  fa: {
    ...
    heroHeadlineSuffix: ".",
    heroSubline: "سلام، من سامسون هستم. به عنوان توسعهدهنده فولاستک و موبایل، کار من فقط نوشتن کدهای تمیز نیست؛ بلکه یک محصول را از اولین جرقه ذهنی تا انتشار نهایی در استور، به طور کامل مدیریت و پیادهسازی میکنم. چه یک پلتفرم وب اختصاصی مد نظرتان باشد و چه یک اپلیکیشن پرسرعت برای iOS و اندروید، من مأموریت دارم تا ایدههای شما را به نرمافزاری پایدار، قدرتمند و چشمنواز تبدیل کنم.",
